...
describe "LayoutLinks" do
    it "should have a Home page at '/'" do
      get '/'
      response.should render_template('pages/home_guest')
    end
    ...
    describe "when signed in" do
      ...
      it "should have no delte option on the users page" do
        get '/users'
        response.should_not have_tag("a[href=?]", user_path(@user), "delete")
      end
    end
end
