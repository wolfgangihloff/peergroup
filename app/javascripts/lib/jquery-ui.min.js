 ...
 */
(function(b,c){function f(g){return!b(g).parents().andSelf().filter(function(){return b.curCSS(this,"visibility")==="hidden"||b.expr.filters.hidden(this)}).length}b.ui=b.ui||{};if(!b.ui.version){b.extend(b.ui,{version:"1.9m3",keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,COMMAND:91,COMMAND_LEFT:91,COMMAND_RIGHT:93,CONTROL:17,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,INSERT:45,LEFT:37,MENU:93,NUMPAD_ADD:107,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,
...
(function(b,c){if(b.cleanData){var f=b.cleanData;b.cleanData=function(e){for(var a=0,d;(d=e[a])!=null;a++)b(d).triggerHandler("remove");f(e)}}else{var g=b.fn.remove;b.fn.remove=function(e,a){return this.each(function(){if(!a)if(!e||b.filter(e,[this]).length)b("*",this).add([this]).each(function(){b(this).triggerHandler("remove")});return g.call(b(this),e,a)})}}b.widget=function(e,a,d){var h=e.split(".")[0],i;e=e.split(".")[1];i=h+"-"+e;if(!d){d=a;a=b.Widget}b.expr[":"][i]=function(n){return!!b.data(n,
e)};b[h]=b[h]||{};b[h][e]=function(n,q){arguments.length&&this._createWidget(n,q)};var j=new a;j.options=b.extend(true,{},j.options);b[h][e].prototype=b.extend(true,j,{namespace:h,widgetName:e,widgetEventPrefix:b[h][e].prototype.widgetEventPrefix||e,widgetBaseClass:i,base:a.prototype},d);b.widget.bridge(e,b[h][e])};b.widget.bridge=function(e,a){b.fn[e]=function(d){var h=typeof d==="string",i=Array.prototype.slice.call(arguments,1),j=this;d=!h&&i.length?b.extend.apply(null,[true,d].concat(i)):d;if(h&&
d.charAt(0)==="_")return j;h?this.each(function(){var n=b.data(this,e),q=n&&b.isFunction(n[d])?n[d].apply(n,i):n;if(q!==n&&q!==c){j=q;return false}}):this.each(function(){var n=b.data(this,e);n?n.option(d||{})._init():b.data(this,e,new a(d,this))});return j}};b.Widget=function(e,a){arguments.length&&this._createWidget(e,a)};b.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:false},_createWidget:function(e,a){b.data(a,this.widgetName,this);this.element=b(a);this.options=
b.extend(true,{},this.options,this._getCreateOptions(),e);var d=this;this.element.bind("remove."+this.widgetName,function(){d.destroy()});this._create();this._trigger("create");this._init()},_getCreateOptions:function(){return b.metadata&&b.metadata.get(this.element[0])[this.widgetName]},_create:function(){},_init:function(){},_super:function(e){return this.base[e].apply(this,Array.prototype.slice.call(arguments,1))},_superApply:function(e,a){return this.base[e].apply(this,a)},destroy:function(){this.element.unbind("."+
this.widgetName).removeData(this.widgetName);this.widget().unbind("."+this.widgetName).removeAttr("aria-disabled").removeClass(this.widgetBaseClass+"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(e,a){var d=e;if(arguments.length===0)return b.extend({},this.options);if(typeof e==="string"){if(a===c)return this.options[e];d={};d[e]=a}this._setOptions(d);return this},_setOptions:function(e){var a=this;b.each(e,function(d,h){a._setOption(d,h)});return this},_setOption:function(e,
a){this.options[e]=a;if(e==="disabled")this.widget()[a?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",a);return this},enable:function(){return this._setOption("disabled",false)},disable:function(){return this._setOption("disabled",true)},_trigger:function(e,a,d){var h=this.options[e];a=b.Event(a);a.type=(e===this.widgetEventPrefix?e:this.widgetEventPrefix+e).toLowerCase();d=d||{};if(a.originalEvent){e=b.event.props.length;for(var i;e;){i=b.event.props[--e];
a[i]=a.originalEvent[i]}}this.element.trigger(a,d);return!(b.isFunction(h)&&h.call(this.element[0],a,d)===false||a.isDefaultPrevented())}}})(jQuery);
...
this._convertPositionTo("absolute");return b.Widget.prototype._trigger.call(this,c,f,g)},plugins:{},_uiHash:function(){return{helper:this.helper,position:this.position,originalPosition:this.originalPosition,offset:this.positionAbs}}});b.extend(b.ui.draggable,{version:"1.9m3"});b.ui.plugin.add("draggable","connectToSortable",{start:function(c,f){var g=b(this).data("draggable"),e=g.options,a=b.extend({},f,{item:g.element});g.sortables=[];b(e.connectToSortable).each(function(){var d=b.data(this,"sortable");
...
c,this.ui(g));return this.element}return false},ui:function(c){return{draggable:c.currentItem||c.element,helper:c.helper,position:c.position,offset:c.positionAbs}}});b.extend(b.ui.droppable,{version:"1.9m3"});b.ui.intersect=function(c,f,g){if(!f.offset)return false;var e=(c.positionAbs||c.position.absolute).left,a=e+c.helperProportions.width,d=(c.positionAbs||c.position.absolute).top,h=d+c.helperProportions.height,i=f.offset.left,j=i+f.proportions.width,n=f.offset.top,q=n+f.proportions.height;
...
b.data(this,"selectable-item");g.$element.removeClass("ui-selecting").addClass("ui-selected");g.selecting=false;g.selected=true;g.startselected=true;f._trigger("selected",c,{selected:g.element})});this._trigger("stop",c);this.helper.remove();return false}});b.extend(b.ui.selectable,{version:"1.9m3"})})(jQuery);
(function(b){b.widget("ui.sortable",b.ui.mouse,{widgetEventPrefix:"sort",options:{appendTo:"parent",axis:false,connectWith:false,containment:false,cursor:"auto",cursorAt:false,dropOnEmpty:true,forcePlaceholderSize:false,forceHelperSize:false,grid:false,handle:false,helper:"original",items:"> *",opacity:false,placeholder:false,revert:false,scroll:true,scrollSensitivity:20,scrollSpeed:20,scope:"default",tolerance:"intersect",zIndex:1E3},_create:function(){this.containerCache={};this.element.addClass("ui-sortable");
this.refresh();this.floating=this.items.length?/left|right/.test(this.items[0].item.css("float")):false;this.offset=this.element.offset();this._mouseInit()},destroy:function(){this.element.removeClass("ui-sortable ui-sortable-disabled").removeData("sortable").unbind(".sortable");this._mouseDestroy();for(var c=this.items.length-1;c>=0;c--)this.items[c].item.removeData("sortable-item");return this},_setOption:function(c,f){if(c==="disabled"){this.options[c]=f;this.widget()[f?"addClass":"removeClass"]("ui-sortable-disabled")}else this._superApply("_setOption",
...
b.extend(b.ui.sortable,{version:"1.9m3"})})(jQuery);
...
[{add:k,remove:l},m,o,p])}});b.extend(b.effects,{version:"1.9m3",save:function(l,k){for(var m=0;m<k.length;m++)k[m]!==null&&l.data("ec.storage."+k[m],l[0].style[k[m]])},restore:function(l,k){for(var m=0;m<k.length;m++)k[m]!==null&&l.css(k[m],l.data("ec.storage."+k[m]))},setMode:function(l,k){if(k=="toggle")k=l.is(":hidden")?"show":"hide";return k},getBaseline:function(l,k){var m;switch(l[0]){case "top":m=0;break;case "middle":m=0.5;break;case "bottom":m=1;break;default:m=l[0]/k.height}switch(l[1]){case "left":l=
...
this.headers.find("a").removeAttr("tabIndex");this._destroyIcons();var f=this.headers.next().css("display","").removeAttr("role").removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content ui-accordion-content-active ui-accordion-disabled ui-state-disabled");if(c.autoHeight||c.fillHeight)f.css("height","");return b.Widget.prototype.destroy.call(this)},_setOption:function(c,f){this._superApply("_setOption",arguments);c=="active"&&this.activate(f);if(c=="icons"){this._destroyIcons();
...
"body",f)[0]).mousedown(function(e){var a=c.menu.element[0];b(e.target).closest(".ui-menu-item").length||setTimeout(function(){b(document).one("mousedown",function(d){d.target!==c.element[0]&&d.target!==a&&!b.ui.contains(a,d.target)&&c.close()})},1);setTimeout(function(){clearTimeout(c.closing)},13)}).menu({input:b(),focus:function(e,a){a=a.item.data("item.autocomplete");false!==c._trigger("focus",e,{item:a})&&/^key/.test(e.originalEvent.type)&&c.element.val(a.value)},select:function(e,a){a=a.item.data("item.autocomplete");
...
this.menu.element.remove();this._super("destroy")},_setOption:function(c){this._superApply("_setOption",arguments);c==="source"&&this._initSource();if(c==="appendTo")this.menu.element.appendTo(b(value||"body",this.element[0].ownerDocument)[0])},_initSource:function(){var c=this,f,g;if(b.isArray(this.options.source)){f=this.options.source;this.source=function(e,a){a(b.ui.autocomplete.filter(f,e.term))}}else if(typeof this.options.source==="string"){g=this.options.source;this.source=function(e,a){c.xhr&&
c.xhr.abort();c.xhr=b.getJSON(g,e,function(d,h,i){i===c.xhr&&a(d);c.xhr=null})}}else this.source=this.options.source},search:function(c,f){c=c!=null?c:this.element.val();this.term=this.element.val();if(c.length<this.options.minLength)return this.close(f);clearTimeout(this.closing);if(this._trigger("search",f)!==false)return this._search(c)},_search:function(c){this.element.addClass("ui-autocomplete-loading");this.source({term:c},this.response)},_response:function(c){if(c&&c.length){c=this._normalize(c);
this._suggest(c);this._trigger("open")}else this.close();this.element.removeClass("ui-autocomplete-loading")},close:function(c){clearTimeout(this.closing);if(this.menu.element.is(":visible")){this._trigger("close",c);this.menu.element.hide();this.menu.deactivate()}},_change:function(c){this.previous!==this.element.val()&&this._trigger("change",c,{item:this.selectedItem})},_normalize:function(c){if(c.length&&c[0].label&&c[0].value)return c;return b.map(c,function(f){if(typeof f==="string")return{label:f,
value:f};return b.extend({label:f.label||f.value,value:f.value||f.label},f)})},_suggest:function(c){this._renderMenu(this.menu.element.empty().zIndex(this.element.zIndex()+1),c);this.menu.deactivate();this.menu.refresh();this.menu.element.show().position(b.extend({of:this.element},this.options.position));this._resizeMenu()},_resizeMenu:function(){var c=this.menu.element;c.outerWidth(Math.max(c.width("").outerWidth(),this.element.outerWidth()))},_renderMenu:function(c,f){var g=this;b.each(f,function(e,
a){g._renderItem(c,a)})},_renderItem:function(c,f){return b("<li></li>").data("item.autocomplete",f).append(b("<a></a>").text(f.label)).appendTo(c)},_move:function(c,f){if(this.menu.element.is(":visible"))if(this.menu.first()&&/^previous/.test(c)||this.menu.last()&&/^next/.test(c)){this.element.val(this.term);this.menu.deactivate()}else this.menu[c](f);else this.search(null,f)},widget:function(){return this.menu.element}});b.extend(b.ui.autocomplete,{escapeRegex:function(c){return c.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,
...
this.buttonElement.removeAttr("title");this._super("destroy")},_setOption:function(e,a){this._superApply("_setOption",arguments);if(e==="disabled")a?this.element.attr("disabled",true):this.element.removeAttr("disabled");this._resetButton()},refresh:function(){var e=this.element.is(":disabled");e!==this.options.disabled&&this._setOption("disabled",e);if(this.type==="radio")g(this.element[0]).each(function(){b(this).is(":checked")?b(this).button("widget").addClass("ui-state-active").attr("aria-pressed",
...
this.hasTitle||e.attr("title",a)}}else e.addClass("ui-button-text-only")}}});b.widget("ui.buttonset",{_create:function(){this.element.addClass("ui-buttonset")},_init:function(){this.refresh()},_setOption:function(e,a){e==="disabled"&&this.buttons.button("option",e,a);this._superApply("_setOption",arguments)},refresh:function(){this.buttons=this.element.find(":button, :submit, :reset, :checkbox, :radio, a, :data(button)").filter(":ui-button").button("refresh").end().not(":ui-button").button().end().map(function(){return b(this).button("widget")[0]}).removeClass("ui-corner-all ui-corner-left ui-corner-right").filter(":visible").filter(":first").addClass("ui-corner-left").end().filter(":last").addClass("ui-corner-right").end().end().end()},
destroy:function(){this.element.removeClass("ui-buttonset");this.buttons.map(function(){return b(this).button("widget")[0]}).removeClass("ui-corner-left ui-corner-right").end().button("destroy");this._super("destroy")}})})(jQuery);
...
d);for(var h in d)if(d[h]==null||d[h]==c)a[h]=d[h];return a}b.extend(b.ui,{datepicker:{version:"1.9m3"}});var e=(new Date).getTime();b.extend(f.prototype,{markerClassName:"hasDatepicker",log:function(){this.debug&&console.log.apply("",arguments)},_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){g(this._defaults,a||{});return this},_attachDatepicker:function(a,d){var h=null;for(var i in this._defaults){var j=a.getAttribute("date:"+i);if(j){h=h||{};try{h[i]=eval(j)}catch(n){h[i]=
...
return this.each(function(){typeof a=="string"?b.datepicker["_"+a+"Datepicker"].apply(b.datepicker,[this].concat(d)):b.datepicker._attachDatepicker(this,a)})};b.datepicker=new f;b.datepicker.initialized=false;b.datepicker.uuid=(new Date).getTime();b.datepicker.version="1.9m3";window["DP_jQuery_"+e]=b})(jQuery);
...
height:"auto"});else{this.uiDialog.show();e=this.element.css("height","auto").height();this.uiDialog.hide();this.element.height(Math.max(e,d))}else this.element.height(Math.max(e.height-a,0));this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option","minHeight",this._minHeight())}});b.extend(b.ui.dialog,{version:"1.9m3",uuid:0,maxZ:0,getTitleId:function(e){e=e.attr("id");if(!e){this.uuid+=1;e=this.uuid}return"ui-dialog-title-"+e},overlay:function(e){this.$el=b.ui.dialog.overlay.create(e)}});
...
(function(b){var c=0;b.widget("ui.menu",{_create:function(){var f=this;this.menuId=this.element.attr("id")||"ui-menu-"+c++;this.element.addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr({id:this.menuId,role:"listbox"}).bind("click.menu",function(g){if(f.options.disabled)return false;if(b(g.target).closest(".ui-menu-item a").length){g.preventDefault();f.select(g)}}).bind("mouseover.menu",function(g){if(!f.options.disabled){var e=b(g.target).closest(".ui-menu-item");e.length&&e.parent()[0]===
f.element[0]&&f.activate(g,e)}}).bind("mouseout.menu",function(g){if(!f.options.disabled){var e=b(g.target).closest(".ui-menu-item");e.length&&e.parent()[0]===f.element[0]&&f.deactivate(g)}});this.refresh();if(!this.options.input)this.options.input=this.element.attr("tabIndex",0);this.options.input.bind("keydown.menu",function(g){if(!f.options.disabled)switch(g.keyCode){case b.ui.keyCode.PAGE_UP:f.previousPage();g.preventDefault();g.stopImmediatePropagation();break;case b.ui.keyCode.PAGE_DOWN:f.nextPage();
g.preventDefault();g.stopImmediatePropagation();break;case b.ui.keyCode.UP:f.previous();g.preventDefault();g.stopImmediatePropagation();break;case b.ui.keyCode.DOWN:f.next();g.preventDefault();g.stopImmediatePropagation();break;case b.ui.keyCode.ENTER:f.select();g.preventDefault();g.stopImmediatePropagation();break}})},destroy:function(){b.Widget.prototype.destroy.apply(this,arguments);this.element.removeClass("ui-menu ui-widget ui-widget-content ui-corner-all").removeAttr("tabIndex").removeAttr("role").removeAttr("aria-activedescendant");
this.element.children(".ui-menu-item").removeClass("ui-menu-item").removeAttr("role").children("a").removeClass("ui-corner-all").removeAttr("tabIndex").unbind(".menu")},refresh:function(){this.element.children("li:not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role","menuitem").children("a").addClass("ui-corner-all").attr("tabIndex",-1)},activate:function(f,g){var e=this;this.deactivate();if(this._hasScroll()){var a=parseFloat(b.curCSS(this.element[0],"borderTopWidth",true))||0,d=parseFloat(b.curCSS(this.element[0],
"paddingTop",true))||0;a=g.offset().top-this.element.offset().top-a-d;d=this.element.attr("scrollTop");var h=this.element.height(),i=g.height();if(a<0)this.element.attr("scrollTop",d+a);else a+i>h&&this.element.attr("scrollTop",d+a-h+i)}this.active=g.first().children("a").addClass("ui-state-hover").attr("id",function(j,n){return e.itemId=n||e.menuId+"-activedescendant"}).end();this.element.removeAttr("aria-activedescenant").attr("aria-activedescenant",e.itemId);this._trigger("focus",f,{item:g})},
deactivate:function(f){if(this.active){var g=this;this.active.children("a").removeClass("ui-state-hover");b("#"+g.menuId+"-activedescendant").removeAttr("id");this.element.removeAttr("aria-activedescenant");this._trigger("blur",f);this.active=null}},next:function(f){this._move("next",".ui-menu-item","first",f)},previous:function(f){this._move("prev",".ui-menu-item","last",f)},first:function(){return this.active&&!this.active.prevAll(".ui-menu-item").length},last:function(){return this.active&&!this.active.nextAll(".ui-menu-item").length},
_move:function(f,g,e,a){if(this.active){f=this.active[f+"All"](".ui-menu-item").eq(0);f.length?this.activate(a,f):this.activate(a,this.element.children(g)[e]())}else this.activate(a,this.element.children(g)[e]())},nextPage:function(f){if(this._hasScroll())if(!this.active||this.last())this.activate(f,this.element.children(".ui-menu-item").first());else{var g=this.active.offset().top,e=this.element.height(),a;this.active.nextAll(".ui-menu-item").each(function(){a=b(this);return b(this).offset().top-
g-e<0});this.activate(f,a)}else this.activate(f,this.element.children(".ui-menu-item")[!this.active||this.last()?"first":"last"]())},previousPage:function(f){if(this._hasScroll())if(!this.active||this.first())this.activate(f,this.element.children(".ui-menu-item").last());else{var g=this.active.offset().top,e=this.element.height(),a;this.active.prevAll(".ui-menu-item").each(function(){a=b(this);return b(this).offset().top-g+e>0});this.activate(f,a)}else this.activate(f,this.element.children(".ui-menu-item")[!this.active||
this.first()?":last":":first"]())},_hasScroll:function(){return this.element.height()<this.element.attr("scrollHeight")},select:function(f){this._trigger("select",f,{item:this.active})}})})(jQuery);
...
this.valueDiv.remove();this._superApply("destroy",arguments)},value:function(f){if(f===c)return this._value();this._setOption("value",f);return this},_setOption:function(f,g){if(f==="value"){this.options.value=g;this._refreshValue();this._trigger("change");this._value()===this.max&&this._trigger("complete")}this._superApply("_setOption",arguments)},_value:function(){var f=this.options.value;if(typeof f!=="number")f=0;return Math.min(this.max,Math.max(this.min,f))},_refreshValue:function(){var f=this.value();
this.valueDiv.toggleClass("ui-corner-right",f===this.max).width(f+"%");this.element.attr("aria-valuenow",f)}});b.extend(b.ui.progressbar,{version:"1.9m3"})})(jQuery);
...
else return this._values()},_setOption:function(c,f){var g,e=0;if(b.isArray(this.options.values))e=this.options.values.length;this._superApply("_setOption",arguments);switch(c){case "disabled":if(f){this.handles.filter(".ui-state-focus").blur();this.handles.removeClass("ui-state-hover");this.handles.attr("disabled","disabled");this.element.addClass("ui-disabled")}else{this.handles.removeAttr("disabled");this.element.removeClass("ui-disabled")}break;case "orientation":this._detectOrientation();this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-"+
this.orientation);this._refreshValue();break;case "value":this._animateOff=true;this._refreshValue();this._change(null,0);this._animateOff=false;break;case "values":this._animateOff=true;this._refreshValue();for(g=0;g<e;g+=1)this._change(null,g);this._animateOff=false;break}},_value:function(){var c=this.options.value;return c=this._trimAlignValue(c)},_values:function(c){var f,g;if(arguments.length){f=this.options.values[c];return f=this._trimAlignValue(f)}else{f=this.options.values.slice();for(g=
0;g<f.length;g+=1)f[g]=this._trimAlignValue(f[g]);return f}},_trimAlignValue:function(c){if(c<this._valueMin())return this._valueMin();if(c>this._valueMax())return this._valueMax();var f=this.options.step>0?this.options.step:1,g=c%f;c=c-g;if(Math.abs(g)*2>=f)c+=g>0?f:-f;return parseFloat(c.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var c=this.options.range,f=this.options,g=this,e=!this._animateOff?f.animate:false,
a,d={},h,i,j,n;if(this.options.values&&this.options.values.length)this.handles.each(function(q){a=(g.values(q)-g._valueMin())/(g._valueMax()-g._valueMin())*100;d[g.orientation==="horizontal"?"left":"bottom"]=a+"%";b(this).stop(1,1)[e?"animate":"css"](d,f.animate);if(g.options.range===true)if(g.orientation==="horizontal"){if(q===0)g.range.stop(1,1)[e?"animate":"css"]({left:a+"%"},f.animate);if(q===1)g.range[e?"animate":"css"]({width:a-h+"%"},{queue:false,duration:f.animate})}else{if(q===0)g.range.stop(1,
1)[e?"animate":"css"]({bottom:a+"%"},f.animate);if(q===1)g.range[e?"animate":"css"]({height:a-h+"%"},{queue:false,duration:f.animate})}h=a});else{i=this.value();j=this._valueMin();n=this._valueMax();a=n!==j?(i-j)/(n-j)*100:0;d[g.orientation==="horizontal"?"left":"bottom"]=a+"%";this.handle.stop(1,1)[e?"animate":"css"](d,f.animate);if(c==="min"&&this.orientation==="horizontal")this.range.stop(1,1)[e?"animate":"css"]({width:a+"%"},f.animate);if(c==="max"&&this.orientation==="horizontal")this.range[e?
"animate":"css"]({width:100-a+"%"},{queue:false,duration:f.animate});if(c==="min"&&this.orientation==="vertical")this.range.stop(1,1)[e?"animate":"css"]({height:a+"%"},f.animate);if(c==="max"&&this.orientation==="vertical")this.range[e?"animate":"css"]({height:100-a+"%"},{queue:false,duration:f.animate})}}});b.extend(b.ui.slider,{version:"1.9m3"})})(jQuery);
(function(b){b.widget("ui.spinner",{options:{incremental:true,max:null,min:null,numberformat:null,step:null,value:null},_create:function(){this._draw();this._markupOptions();this._mousewheel();this._aria()},_markupOptions:function(){var c=this;b.each({min:-Number.MAX_VALUE,max:Number.MAX_VALUE,step:1},function(f,g){if(c.options[f]===null){var e=c.element.attr(f);c.options[f]=typeof e=="string"&&e.length>0?c._parse(e):g}});this.value(this.options.value!==null?this.options.value:this.element.val()||
0)},_draw:function(){var c=this,f=c.options,g=this.uiSpinner=c.element.addClass("ui-spinner-input").attr("autocomplete","off").wrap(c._uiSpinnerHtml()).parent().append(c._buttonHtml()).hover(function(){f.disabled||b(this).addClass("ui-state-hover");c.hovered=true},function(){b(this).removeClass("ui-state-hover");c.hovered=false});!b.support.opacity&&g.css("display")=="inline-block"&&b.browser.version<8&&g.css("display","inline");this.element.bind("keydown.spinner",function(e){if(!c.options.disabled){if(c._start(e))return c._keydown(e);
return true}}).bind("keyup.spinner",function(e){if(!c.options.disabled)if(c.spinning){c._stop(e);c._change(e)}}).bind("focus.spinner",function(){g.addClass("ui-state-active");c.focused=true}).bind("blur.spinner",function(){c.value(c.element.val());c.hovered||g.removeClass("ui-state-active");c.focused=false});this.buttons=g.find(".ui-spinner-button").attr("tabIndex",-1).button().removeClass("ui-corner-all").bind("mousedown",function(e){if(!c.options.disabled){if(c._start(e)===false)return false;c._repeat(null,
b(this).hasClass("ui-spinner-up")?1:-1,e)}}).bind("mouseup",function(e){if(!c.options.disabled)if(c.spinning){c._stop(e);c._change(e)}}).bind("mouseenter",function(){if(!c.options.disabled)if(b(this).hasClass("ui-state-active")){if(c._start(event)===false)return false;c._repeat(null,b(this).hasClass("ui-spinner-up")?1:-1,event)}}).bind("mouseleave",function(){if(c.spinning){c._stop(event);c._change(event)}});f.disabled&&this.disable()},_keydown:function(c){var f=b.ui.keyCode;switch(c.keyCode){case f.UP:this._repeat(null,
1,c);return false;case f.DOWN:this._repeat(null,-1,c);return false;case f.PAGE_UP:this._repeat(null,10,c);return false;case f.PAGE_DOWN:this._repeat(null,-10,c);return false;case f.ENTER:this.value(this.element.val())}return true},_mousewheel:function(){if(b.fn.mousewheel){var c=this;this.element.bind("mousewheel.spinner",function(f,g){if(!c.options.disabled){if(!c.spinning&&!c._start(f))return false;c._spin((g>0?1:-1)*c.options.step,f);clearTimeout(c.timeout);c.timeout=setTimeout(function(){if(c.spinning){c._stop(f);
c._change(f)}},100);f.preventDefault()}})}},_uiSpinnerHtml:function(){return'<div role="spinbutton" class="ui-spinner ui-state-default ui-widget ui-widget-content ui-corner-all"></div>'},_buttonHtml:function(){return'<a class="ui-spinner-button ui-spinner-up ui-corner-tr"><span class="ui-icon ui-icon-triangle-1-n">&#9650;</span></a><a class="ui-spinner-button ui-spinner-down ui-corner-br"><span class="ui-icon ui-icon-triangle-1-s">&#9660;</span></a>'},_start:function(c){if(!this.spinning&&this._trigger("start",
c)!==false){if(!this.counter)this.counter=1;return this.spinning=true}return false},_repeat:function(c,f,g){var e=this;c=c||500;clearTimeout(this.timer);this.timer=setTimeout(function(){e._repeat(40,f,g)},c);e._spin(f*e.options.step,g)},_spin:function(c,f){if(!this.counter)this.counter=1;c=this.value()+c*(this.options.incremental&&this.counter>20?this.counter>100?this.counter>200?100:10:2:1);if(this._trigger("spin",f,{value:c})!==false){this.value(c);this.counter++}},_stop:function(c){this.counter=
0;this.timer&&window.clearTimeout(this.timer);this.element[0].focus();this.spinning=false;this._trigger("stop",c)},_change:function(c){this._trigger("change",c)},_setOption:function(c,f){if(c=="value"){f=this._parse(f);if(f<this.options.min)f=this.options.min;if(f>this.options.max)f=this.options.max}if(c=="disabled")if(f){this.element.attr("disabled",true);this.buttons.button("disable")}else{this.element.removeAttr("disabled");this.buttons.button("enable")}b.Widget.prototype._setOption.call(this,
c,f)},_setOptions:function(c){b.Widget.prototype._setOptions.call(this,c);"value"in c&&this._format(this.options.value);this._aria()},_aria:function(){this.uiSpinner.attr("aria-valuemin",this.options.min).attr("aria-valuemax",this.options.max).attr("aria-valuenow",this.options.value)},_parse:function(c){if(typeof c=="string"){if(this.options.numberformat=="C"&&window.Globalization)c=c.replace((Globalization.culture||Globalization.cultures["default"]).numberFormat.currency.symbol,"");c=window.Globalization&&
this.options.numberformat?Globalization.parseFloat(c):+c}return isNaN(c)?null:c},_format:function(c){c=this.options.value;this.element.val(window.Globalization&&this.options.numberformat?Globalization.format(c,this.options.numberformat):c)},destroy:function(){this.element.removeClass("ui-spinner-input").removeAttr("disabled").removeAttr("autocomplete");b.Widget.prototype.destroy.call(this);this.uiSpinner.replaceWith(this.element)},stepUp:function(c){this._spin((c||1)*this.options.step)},stepDown:function(c){this._spin((c||
1)*-this.options.step)},pageUp:function(c){this.stepUp((c||1)*10)},pageDown:function(c){this.stepDown((c||1)*10)},value:function(c){if(!arguments.length)return this._parse(this.element.val());this.option("value",c)},widget:function(){return this.uiSpinner}})})(jQuery);
...
h){this.anchors.eq(d).removeData("cache.tabs").data("load.tabs",h);return this},length:function(){return this.anchors.length}});b.extend(b.ui.tabs,{version:"1.9m3"});b.extend(b.ui.tabs.prototype,{rotation:null,rotate:function(d,h){var i=this,j=this.options,n=i._rotate||(i._rotate=function(q){clearTimeout(i.rotation);i.rotation=setTimeout(function(){var l=j.selected;i.select(++l<i.anchors.length?l:0)},d);q&&q.stopPropagation()});h=i._unrotate||(i._unrotate=!h?function(q){q.clientX&&i.rotate(null)}:
...
(function(b){var c=0;b.widget("ui.tooltip",{options:{items:"[title]",content:function(){return b(this).attr("title")},position:{my:"left center",at:"right center",offset:"15 0"}},_create:function(){var f=this;this.tooltip=b("<div></div>").attr("id","ui-tooltip-"+c++).attr("role","tooltip").attr("aria-hidden","true").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content").appendTo(document.body).hide();this.tooltipContent=b("<div></div>").addClass("ui-tooltip-content").appendTo(this.tooltip);
this.opacity=this.tooltip.css("opacity");this.element.bind("focus.tooltip mouseover.tooltip",function(g){f.open(g)}).bind("blur.tooltip mouseout.tooltip",function(g){f.close(g)})},enable:function(){this.options.disabled=false},disable:function(){this.options.disabled=true},destroy:function(){this.tooltip.remove();b.Widget.prototype.destroy.apply(this,arguments)},widget:function(){return this.element.pushStack(this.tooltip.get())},open:function(f){var g=b(f&&f.target||this.element).closest(this.options.items);
if(!(this.current&&this.current[0]==g[0])){var e=this;this.current=g;this.currentTitle=g.attr("title");var a=this.options.content.call(g[0],function(d){setTimeout(function(){e.current==g&&e._show(f,g,d)},13)});a&&e._show(f,g,a)}},_show:function(f,g,e){if(e){g.attr("title","");if(!this.options.disabled){this.tooltipContent.html(e);this.tooltip.css({top:0,left:0}).show().position(b.extend({of:g},this.options.position)).hide();this.tooltip.attr("aria-hidden","false");g.attr("aria-describedby",this.tooltip.attr("id"));
this.tooltip.stop(false,true).fadeIn();this._trigger("open",f)}}},close:function(f){if(this.current){var g=this.current.attr("title",this.currentTitle);this.current=null;if(!this.options.disabled){g.removeAttr("aria-describedby");this.tooltip.attr("aria-hidden","true");this.tooltip.stop(false,true).fadeOut();this._trigger("close",f)}}}})})(jQuery);
