Feature: Providing the topic on supervision session
  ...
  Scenario: Providing the topic as the first one
    Given I am on the homepage
     When I follow "Session" within "Developers" group brief
  ...
  Scenario: Providing the topic as the last one
    Given a supervision: "Current supervision" exists with group: group "Developers"
      And a topic exists with supervision: supervision "Current supervision", user: user "Wolfgang", content: "How to cook dinner?"
